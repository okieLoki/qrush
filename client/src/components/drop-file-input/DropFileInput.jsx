...
const DropFileInput = props => {
    ...
    const onFileSubmit = () => {
        ...
        formData.append('myfile', file, 'myfile'); // specify desired filename here
        axios.post('https://qrush-backend.onrender.com/api/files', formData, {
            headers: {
            ...
            .then((response) => {
                ...
                let qrCodeUrl = `https://chart.googleapis.com/chart?cht=qr&chl=${encodeURIComponent(response.data.file)}&chs=280x280`;
                setqrCode(qrCodeUrl);
                setShowLink(true);
            })
            .catch(error => {
                ...
                file && !showLink ? (
                    <div className="drop-file-preview">
                        ...
                        <div className='button-div'>
                            <button className="btn-blue" onClick={onFileSubmit}>Submit</button>
                            {
                                response ? (
            ...
            {showLink && (
                <>
                    ...
                    <div className='btn-container'>
                        ...
                        <button className='btn-blue' onClick={() => goBack()}>Go Back</button>
                        </div>
                    </div>
                </>
            )
